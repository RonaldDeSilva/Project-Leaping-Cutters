    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.CompareTag("Deathbox"))
        {
            ...
            if (lives > 0)
            {
                ...
                Can.transform.GetChild(2).GetChild(1).gameObject.GetComponent<SpriteRenderer>().color = Color.green;
                Can.transform.GetChild(2).GetChild(2).gameObject.GetComponent<SpriteRenderer>().color = Color.green;
