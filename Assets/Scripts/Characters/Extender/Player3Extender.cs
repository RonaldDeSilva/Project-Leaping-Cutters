...
public class Player3Extender : MonoBehaviour
{
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.CompareTag("Deathbox"))
        {
            ...
            if (lives != 1)
            {
                ...
                Can.transform.GetChild(2).GetChild(1).gameObject.GetComponent<Image>().color = Color.white;
                Can.transform.GetChild(2).GetChild(2).gameObject.GetComponent<Image>().color = Color.blue;
    ...
    IEnumerator Dash()
    {
        ...
        Dashing = true;
        Can.transform.GetChild(2).GetChild(1).gameObject.GetComponent<Image>().color = Color.red;
    ...
    IEnumerator Extend()
    {
        ...
        Extending = true;
        Can.transform.GetChild(2).GetChild(2).gameObject.GetComponent<Image>().color = Color.red;
